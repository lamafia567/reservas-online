    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="{{url('/')}}" class="logo d-flex align-items-center me-auto">
          ...
          <h1 class="sitename">Sistema medico de reserva de clinica estetica.</h1>
        </a>
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="#hero" class="active"><br></a></li>
    ...
    <section id="hero" class="hero section light-background">
      ...
      <div class="container position-relative">
        ...
        <div class="welcome position-relative" data-aos="fade-down" data-aos-delay="100">
          <h2>Bienvenido.</h2>
          <p>La mejor clinica estetica</p>
        </div><!-- End Welcome -->

        <div class="content row gy-4">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
              <h3>Reserva tu cita aca.</h3>
              <div class="text-center">
                <a href="{{url('/admin')}}" class="more-btn"><span>Reservar cita</span> <i class="bi bi-chevron-right"></i></a>
              </div>
            </div>
          </div>
          <!-- End Why Box -->
