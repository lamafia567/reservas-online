                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form group">
                                    ...
                                    <input name="fecha_visita" type="date" value="{{$historial->fecha_visita}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="detalle" class="form-control" id="editor" cols="30" rows="10" style="width: 100%; ">{!! $historial->detalles !!}</textarea>
